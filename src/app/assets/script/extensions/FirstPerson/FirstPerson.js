!(function () {
  ...
  AutodeskNamespace("Autodesk.Viewing.Extensions.FirstPerson"),
    (Autodesk.Viewing.Extensions.FirstPerson.FirstPersonExtension = function (
      a,
      b
    ) {
      Autodesk.Viewing.Extension.call(this, a, b);
    }),
    (Autodesk.Viewing.Extensions.FirstPerson.FirstPersonExtension.prototype =
      Object.create(Autodesk.Viewing.Extension.prototype)),
    (Autodesk.Viewing.Extensions.FirstPerson.FirstPersonExtension.prototype.constructor =
      Autodesk.Viewing.Extensions.FirstPerson.FirstPersonExtension),
    (Autodesk.Viewing.Extensions.FirstPerson.FirstPersonExtension.prototype.load =
      function () {
        var a = this,
          b = this.viewer,
          c = Autodesk.Viewing.UI;
        return (
          (this.tool =
            new Autodesk.Viewing.Extensions.FirstPerson.FirstPersonTool(b)),
          b.toolController.registerTool(this.tool),
          this.createUI(),
          (this.onToolChanged = function (b) {
            if (
              -1 !== b.toolName.indexOf("firstperson") &&
              a.firstPersonToolButton
            ) {
              var d = b.active
                ? c.Button.State.ACTIVE
                : c.Button.State.INACTIVE;
              a.firstPersonToolButton.setState(d);
            }
          }),
          b.addEventListener(
    ...
    (Autodesk.Viewing.Extensions.FirstPerson.FirstPersonExtension.prototype.createUI =
      function () {
        var a = this.viewer;
        if (a.getToolbar) {
          var b = this,
            c = Autodesk.Viewing.UI,
            d = a.getToolbar(!0),
            e = d.getControl(Autodesk.Viewing.TOOLBAR.NAVTOOLSID);
          (this.firstPersonToolButton = new c.Button(
            "toolbar-firstPersonTool"
          )),
            this.firstPersonToolButton.setToolTip("First person"),
            (this.firstPersonToolButton.onClick = function (d) {
              var e = b.firstPersonToolButton.getState();
              e === c.Button.State.INACTIVE
                ? a.setActiveNavigationTool("firstperson")
                : e === c.Button.State.ACTIVE && a.setActiveNavigationTool();
            }),
            this.firstPersonToolButton.setIcon("adsk-icon-first-person");
          var f = e.getControl("toolbar-cameraSubmenuTool");
          f
            ? e.addControl(this.firstPersonToolButton, {
                index: e.indexOf(f.getId()),
              })
            : e.addControl(this.firstPersonToolButton);
        }
      }),
    (Autodesk.Viewing.Extensions.FirstPerson.FirstPersonExtension.prototype.unload =
      function () {
        var a = this.viewer;
        if (
          ...
          this.firstPersonToolButton)
        ) {
          var b = a.getToolbar(!1);
          b &&
            b
              .getControl(Autodesk.Viewing.TOOLBAR.NAVTOOLSID)
              .removeControl(this.firstPersonToolButton.getId()),
            (this.firstPersonToolButton = null);
        }
        return (
          a.getActiveNavigationTool() == this.tool.getName() &&
            a.setActiveNavigationTool(),
          a.toolController.deregisterTool(this.tool),
          (this.tool = null),
          !0
        );
      }),
  ...
  (function () {
    AutodeskNamespace("Autodesk.Viewing.Extensions.FirstPerson"),
      (Autodesk.Viewing.Extensions.FirstPerson.FirstPersonTool = function (a) {
        function b(a) {
          if (p) return !1;
          var b = a.ctrlKey || (e && a.metaKey),
            c = a.metaKey && !e;
          return b || c || a.shiftKey || a.altKey;
        }
        var c,
          d = Autodesk.Viewing.Private,
          e = -1 != navigator.userAgent.search("Mac OS"),
          f = a.navigation,
          g = a.container,
          h = f.getCamera(),
          i = ["firstperson"],
          j = { SHIFT: 0, ALT: 0, CONTROL: 0 },
          k = Autodesk.Viewing.KeyCode,
          l = !1,
          m = !0,
          n = !1,
          o = 0,
        ...
        (this.isActive = function () {
          ...
          (this.activate = function (b) {
            q.start(),
              ...
              f.toPerspective(),
              (L = h.fov),
              f.setVerticalFov(75, !0),
              (t = a.model.getUnitScale());
            var d = a.model.getBoundingBox().size();
            (u = Math.max(Math.min(Math.min(d.x, d.y), d.z) / 10, 1e-4)),
              a.canvas.focus(),
              (l = !0),
              a.getFirstPersonToolPopup() && !N && T(),
              addCrosshair(),
              a.impl.pauseHighlight(!0),
              c && c.activate(this.getName());
          }),
          ...
          (this.adjustSpeed = function (a) {
            0 === a ? (v = 2) : (v *= a > 0 ? 1.1 : 0.9) < 0.01 && (v = 0.01);
          }),
          (this.handleGesture = function (a) {
            switch (
              (a.pointers &&
                a.pointers.length > 0 &&
                ((a.pageX = a.pointers[0].pageX),
                (a.pageY = a.pointers[0].pageY)),
              a.type)
            ) {
              case "dragstart":
                return (p = "drag"), this.handleButtonDown(a, 0);
              case "dragmove":
                return "drag" === p && this.handleMouseMove(a);
              case "dragend":
                return (
                  "drag" === p && (this.handleButtonUp(a, 0), (p = null), !0)
                );
            }
            return !1;
          }),
          ...
          (this.handleButtonDown = function (a, c) {
            R(), (o += 1 << c);
            var d = b(a);
            return (
              !(0 === c && !d) ||
              ((x = a.pageX - window.innerWidth / 2),
              (A = a.pageY - window.innerHeight / 2),
              (z = a.pageX),
              (C = a.pageY),
              (D = E = 0),
              (y = B = 0),
          ...
          (this.handleMouseMove = function (a) {
            var b = z < -1e10 ? 0 : a.pageX - z,
              c = C < -1e10 ? 0 : a.pageY - C;
            return (
              (z = a.pageX),
              (C = a.pageY),
              n === m && ((D += 0.0035 * b), (E += 0.0035 * c)),
              !0
            );
          }),
          ...
          (this.handleKeyDown = function (a, b) {
            ...
            switch (b) {
              ...
              case k.SPACE:
                ...
                break;
              case k.EQUALS:
                this.adjustSpeed(1), (c = !0);
                break;
              case k.DASH:
                this.adjustSpeed(-1), (c = !0);
                break;
              case k.ZERO:
                this.adjustSpeed(0), (c = !0);
                break;
              case k.UP:
              case k.w:
                (F = !0), (c = !0);
          ...
          (this.handleWheelInput = function (a) {
            return f.getReverseZoomDirection() && (a *= -1), (w += a), !0;
          }),
          (this.handleSingleClick = function (a, b) {
            return !1;
          }),
          ...
          (this.handleBlur = function (a) {
            return (F = G = !1), (H = I = !1), (J = K = !1), !1;
          }),
          (this.update = function () {
            if (!l || !f.isActionEnabled("walk")) return !1;
            var a = q.getDelta();
            if (r > -1) {
              new Date().getTime() - r > s && R();
            }
            h.isPerspective ||
              (console.log("Lost perspective mode: resetting view."),
              f.toPerspective());
            var b = h.clone(),
              d = a * v * u * (1 === j.SHIFT ? 4 : 1),
              e = 0.5 * a * u * (1 === j.SHIFT ? 4 : 1);
            if (0 != w) {
              var g = 1 * w * u * (1 === j.SHIFT ? 4 : 1);
              b.translateZ(-g), (w = 0);
            }
            F && b.translateZ(-d),
              G && b.translateZ(d),
              ...
              K && b.translateY(-e);
            var i = b.position,
              k = 0 !== i.distanceToSquared(h.position),
              m = b.target,
              n = h.target.clone().sub(h.position),
              o = n.clone().cross(h.up).normalize();
            if (0 != E) {
              var p = new THREE.Quaternion();
              p.setFromAxisAngle(o, -E);
              var t = n.clone();
              t.applyQuaternion(p);
              var x = h.worldup.clone(),
                y = t.angleTo(x),
                z = THREE.Math.degToRad(5);
              y >= z &&
                y <= Math.PI - z &&
                (n.applyQuaternion(p), b.up.applyQuaternion(p)),
                (E = 0);
            }
            if (0 != D) {
              var A = new THREE.Quaternion();
              A.setFromAxisAngle(h.worldup, -D),
                n.applyQuaternion(A),
                b.up.applyQuaternion(A),
                (D = 0);
            }
            m = i.clone().add(n);
            var B = 0 !== m.distanceToSquared(h.target);
            return (
              (k || B) && (f.setView(i, m), f.orientCameraUp()),
              c && (h = c.update(h)),
              h.dirty
            );
          });
          ...
          T = function () {
            R(),
              Q(
                ...
                function (b) {
                  (N = b.target.checked),
                    a.setFirstPersonToolPopup(!b.target.checked);
                }
              );
          };
        (addCrosshair = function () {
          d.stringToDOM &&
            ((this.crosshair = d.stringToDOM(
              '<div id="remote-crosshair"><div class="crosshair-v"></div><div class="crosshair-h"></div></div>f'
            )),
            a.canvasWrap.appendChild(this.crosshair));
        }),
          (removeCrosshair = function () {
            this.crosshair &&
              this.crosshair.parentNode &&
